...
Seguimiento de contacto en frío — ver guiones y guía de búsqueda en `03-gtm/`. Se rellena conforme se contacta a alguien, para no perder seguimiento ni duplicar.

**Cómo funciona:** cada vez que Alberto escribe a alguien, lo cuenta en la conversación (a quién, qué guion/versión usó, si hubo respuesta) y Claude lo añade aquí. Cuando hay respuesta (positiva o negativa), se actualiza la fila — y si hay suficiente patrón, se sintetiza en `seguimiento/aprendizajes-venta.md`.

| Fecha contacto | Nombre / empresa | Tipo (gestoría / cámara / pyme directa) | Vía (Guion 1 / Guion 2 / otro) | Estado (enviado / respondió sí / respondió no / sin respuesta) | Notas / qué dijo |
|---|---|---|---|---|---|
...
**Objetivo de estos mensajes**: conseguir 15 minutos de conversación, no cerrar condiciones de colaboración — la comisión, si tiene sentido, se habla en esa conversación, no en el mensaje frío (Módulo 6). Alberto habla en nombre propio, sin marca aparte (Módulo 5).

### Email a Carlos García García (MZG Asesores)
...
>
> Te escribo porque en MZG asesoráis a más de 300 empresas, y eso os pone en una posición privilegiada para detectar cuándo un cliente tiene este tipo de problema —datos y procesos dispersos, decisiones a ojo— aunque él mismo todavía no lo sepa.
>
...
### LinkedIn a Lola Ferrer Garcerán (Arrabe Integra)

> Hola Lola,
>
> Soy Alberto Mariscal — he liderado funciones de datos en empresas grandes (Endesa, niba — Grupo Iberdrola) y ahora ayudo a pymes a poner orden en cómo usan su información: qué comprar, qué automatizar, qué simplemente organizar.
>
> Te escribo porque en Arrabe lleváis 50 años acompañando a empresas familiares, y ya trabajáis con proyectos tecnológicos e innovadores — seguro que reconocéis rápido cuándo un cliente tiene datos y procesos dispersos, aunque él mismo no lo haya identificado todavía.
>
> Me gustaría contarte en 15 minutos a qué me dedico, para que tengas criterio propio de cuándo puede encajarte con algún cliente — y ver si tiene sentido colaborar. ¿Tendrías un hueco esta semana o la que viene?
>
> Un saludo,
> Alberto

...
- **MVP: solo borradores.** Claudio nunca envía por iniciativa propia. Deja cada candidato en **"Pendiente aprobación"** con el correo redactado dentro del cuerpo de la tarjeta de Notion (Mensaje, Destinatario, Análisis de la empresa, Análisis de la persona, Por qué contactarles). Un correo solo sale cuando Alberto revisa y mueve el ticket a **"Pendiente envío"**; Claudio lee entonces los comentarios del ticket, ajusta, envía y mueve la tarjeta a **"Enviados"**. Flujo: Backlog → Pendiente aprobación → Pendiente envío → Enviados → Respondido/Reunión/Ignorado.

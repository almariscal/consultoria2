...
| Listo | Si cada uno puede montarse su software, las empresas van a tener que abrir sus datos (APIs y MCPs) | `posts/2026-08-06-apis-y-mcps/` | 2026-08-06 (jue) | Caso/evidencia real: `almariscal/seguimiento_economico` (herramienta propia para unificar inversiones de seis plataformas). Segunda parte del post del DNI: si cualquiera se construye su herramienta, el software compite por si deja salir los datos. Contrapunto verificado: Revolut abrió Revolut X a asistentes de IA vía MCP (anuncio 10/07/2026). **Sin enlace**: el repo es privado (finanzas personales). Incluye `frase.png` (tarjeta-cita) |
